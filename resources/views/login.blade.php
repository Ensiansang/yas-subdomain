...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backend/images/yas-favicon.png') }}">

    <title>YAS - Log in </title>
...
if (Auth::check()) {
    if (auth()->user()->role_id == 2) {
        ...
        echo '<script>window.location.href = "' . route('teacher.dashboard') . '";</script>';
    }
}
@endphp
...
<body class="hold-transition theme-primary bg-gradient-primary">
    ...
    <div class="container h-p100">
     ...
     <form method="POST" action="{{ route('stutechlogin') }}">
            @csrf
