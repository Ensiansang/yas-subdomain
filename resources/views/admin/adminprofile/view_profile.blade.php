...
<div class="box box-widget widget-user">
 ...
 <div class="widget-user-header bg-black">
	  ...
	  <!-- <h6 class="widget-user-desc">User Role : {{ $roleName }}</h6>
  ...
  <img class="rounded-circle"
   src="{{ (!empty($user->image))? url('upload/admin_img/'.$user->image):url('upload/no_image.jpg') }} " alt="Admin Avatar">
					</div>
					  ...
					  <div class="row">
						...
						<div class="col-sm-4 br-1 bl-1">
						  <div class="description-block">
							...
							<span class="description-text">{{ $roleName }}</span>
						  </div>
						  <!-- /.description-block -->
						</div>
						<!-- /.col -->
