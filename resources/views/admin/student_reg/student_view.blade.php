...
<div class="box bb-3 border-warning">
		...
		<form method="GET" action="{{ route('student.class.get') }}">
	 ...
	 <table id="example1" class="table table-bordered table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td>
	 <img src="{{ (!empty($value['student']['image']))? url('upload/student_img/'.$value['student']['image']):url('upload/no_image.jpg') }}" style="width: 60px; width: 60px;"> 
				</td>	
...
<a title="Promotion" href="" class="btn btn-primary" ><i class="fa fa-check"></i></a>
